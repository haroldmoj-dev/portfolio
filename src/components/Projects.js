import ProjectTImg from "../assets/projects/project-t.png";
...
const projects = [
  ...
  {
    title: "SpringTales",
    description: "Website storing infographics about the game 'Guardian Tales'.",
  ...
  },
  {
    ...
    link: "https://github.com/haroldmoj-dev/gamemaker-project-t",
    image: ProjectTImg,
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 w-full">
        {projects.map((proj) => (
          <div 
            key={proj.title}
            className="rounded-lg bg-accent transition relative overflow-hidden border-2 border-transparent hover:border-text hover:-translate-y-4 flex flex-col"
          >
            <div
            ...
            <div className="relative z-10 bg-accent flex-grow">
              <div className="p-4">
